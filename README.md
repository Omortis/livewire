...
## Inputs And Exercise Generation

The exercises in this repo were all generated by an LLM (kimi 2.6 in OpenCode as it happens). The input specs and output files for these generation efforts are as follows:

### Python

**Input:** `python_coursework.md`  
**Output:** `python_homework.md`

*Note:* `python_homework_original.md` is the original output file, without my code and output pasted inline.

### Java/Kotlin

**Input:** `java_kotlin_coursework.md`  
**Output:** `java_kotlin_homework.md`

*Note:* `java_kotlin_homework_original.md` is the original output file, without my code and output pasted inline.

While the exercises were generated by an LLM, *all of the code and output contained in the homework files was created by hand - no code generation was applied at all*. I did ask the LLM to check my work as part of the larger effort. Code review is always a good idea.

...
The exercises in the repo are all generated by an LLM (kimi 2.6 in OpenCode as it happens). The input specs and output files for these generation efforts are as follows:
...
While the exercises were generated by an LLM, *all of the code and output contained in the homework files was created by hand - not code generation was applied at all.*. I did ask the LLM to check my work as part of the larger effort. Code review is always a good idea.
